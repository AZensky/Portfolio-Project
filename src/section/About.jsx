...
import { aboutVector, david } from '../assets';
        ...
        <Box
          ...
          <Box sx={{ textAlign: 'left' }}>
            <Typography
              ...
              Alex
              <Typography variant='h2' component='span' sx={{ color: (theme) => theme.palette.primary.main }}>
                {' '}
                Zelinsky{' '}
              </Typography>
            </Typography>
            <Typography variant='h4' sx={{ color: (theme) => theme.palette.primary.light, my: 1.1 }}>
              Creative{' '}
            ...
            <Typography variant='h5' sx={{ mt: 1.5 }}>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Etiam eu turpis molestie, dictum est a, mattis
